...
//		Peer peerInstance = new Peer(1, 8001);
		...
		try {
			...
			while (true) {
				...
				System.out.println("");
				System.out.println("************************************************************************");
				System.out.println("**** Maintaining File Consistency in your Gnutella Style P2P System ****");
				System.out.println("************************************************************************");
				System.out.println("1. Search and Download File");
				System.out.println("2. Modify File");
				if (!peerInstance.isPush)
					System.out.println("3. AutoUpdate");
				...
				switch (scan.next()) {
					...
					case "2":
						System.out.println("Enter file name to search:");
						String modifyFileName = scan.next();
						peerInstance.modifyFile(modifyFileName);
						break;
