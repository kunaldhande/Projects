 ...
 *      const char *const pageFileName  : Page File Name
 *      const int numPages              : Number of Pages
 *      ReplacementStrategy strategy    : Strategy(LRU, FIFO)
 *      void *stratData                 : Data
 *
 *  Return:
 *      RC : Return Code specified in the file "dberror.h".
 *      RC_BUFFER_INIT_FAIL : Buffer Intialization Failed
 *
 *  Variables:
 *      None.
 *
...
*  Return:
*       RC : Return Code specified in the file "dberror.h".
*       RC_BUFFERPOOL_NULL : Buffer pool is Null.
*       RC_WRITE_FAILED     : Write failed.
*       RC_UNABLE_TO_SHUTDOWN_BUFFERPOOL : Unable to shutdown buffer pool.
*
*  Variables:
*      None.
*
 ...
 *  Return:
 *      RC : Return Code specified in the file "dberror.h".
 *      RC_WRITE_FAILED : Writing to buffer failed.
 *
 *  Variables:
 *      None.
 *
 ...
 *
 *  Description:
 *      Return contents of a frame.
 *
 *  Parameters:
 *      BM_BufferPool *const bm         : Buffer object
 *
 *  Return:
 *      PageNumber  : Value of frameContents whic has the valus of the content.
 *
 *  Variables:
 *      None.
 *
 ...
 *
 *  Description:
 *      Get flags for Dirty pages.
 *
 *  Parameters:
 *      BM_BufferPool *const bm         : Buffer object
 *
 *  Return:
 *      bool : True if page is dirty, False if not.
 *
 *  Variables:
 *      None.
 *
 ...
 *
 *  Return:
 *      int : write count of buffer pool.
 *
 *  Variables:
 *      None.
 *
